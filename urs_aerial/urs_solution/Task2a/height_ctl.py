...
from urs_solution.cfg import MavZCtlParamsConfig
...
class HeightControl:
    ...
    def __init__(self):
        ...
        self.attitude_ctl = rospy.get_param('~attitude_control')   # flag indicates if attitude control is turned on
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.mot_speed = self.pid_vz.compute(self.vz_sp, self.vz_mv) + hover_0
